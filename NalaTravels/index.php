...
$headerArray = ["home", "contact", "overons", "search", "dashboard", "book", "review"];
$footerArray = ["home", "contact", "overons", "search", "login", "register", "review"];
...
<head>
    ...
    <script src="assets/js/customElements/customElements.js"></script>
